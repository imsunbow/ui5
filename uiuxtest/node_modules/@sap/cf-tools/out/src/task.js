...
function getTaskJsonContentAsJsonObject(taskJsonFilePath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const tasksJsonString = yield fsextra.readFile(taskJsonFilePath, "utf8");
            const tasksJson = comment_json_1.parse(tasksJsonString);
...
function saveTaskConfiguration(wsFolderPath, configuration) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield fsextra.outputFile(taskJsonFilePath, comment_json_1.stringify(tasksJson, undefined, "  "));
    });
}
