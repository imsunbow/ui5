...
exports.messages = {
    ...
    failed_creating_entity: (description, name) => `Could not create the ${description}  entity, consider deleting it using the 'cf delete-service ${name} command'`,
    exceed_number_of_attempts: (name) => `Could not change the service-instance to the 'readSync' state. You may monitor its status using the'cf service ${name}' command`,
