import { ProgressHandler, CFResource, CancellationToken, CFTarget, ServiceInstanceInfo, ServiceInfo, PlanInfo, IServiceQuery, ITarget, UpsTypeInfo } from './types';
export declare function clearCacheServiceInstances(): void;
export declare function cfGetConfigFilePath(): string;
export declare function cfGetConfigFileField(field: string): Promise<any>;
...
export declare function cfGetServiceKeys(query?: IServiceQuery, token?: CancellationToken): Promise<any[]>;
