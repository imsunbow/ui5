sap.ui.define([
    ...
    return Controller.extend("code1.cl5.abap3.code1cl5abap32nd2.controller.CRUDView", {
        onInit() {
        },
        ...
        onClear: function()
        {
            ...
            this.getView().byId('Smeng').setValue('0'); // 초기값으로 0 부여 
            this.getView().byId('Meins').setValue();
            this.getView().byId('Netwr').setValue('0'); // 초기값으로 0 부여
        ...
        onRead: function()
        {
            ...
            // OData Entity 경로 생성: /Shipset(Tknum='값',Tpnum='값')
        ...
        onCreate: function()
        {
            ...
            // 사용자가 입력한 Tknum, Tpnum 값을 변수에 저장
        ...
        onUpdate: function()
        {
            ...
            // 사용자가 입력한 Tknum, Tpnum값을 받아서 변수형태로 저장
            ...
            let oModel = oView.getModel(),
                ...
                oModel.update("/ShipSet(Tknum='" + vTknum + "',Tpnum='" + vTpnum+"')",
                    ...
                    oData,
                    {
                        success: function()
                        {
                            ...
                            MessageToast.show("update success"); // 성공 메세지 출력
                        },

                        error: function()
                        {
                            MessageToast.show("update fail");  // 실패 메세지 출력
                        }
        ...
        onDelete: function()
        {
            ...
            // OData Delete 요청
            oModel.remove("/ShipSet(Tknum='" + oData.Tknum + "',Tpnum='" + oData.Tpnum+"')",
            {
                success: function()
                {
                    oModel.refresh(); // 화면 갱신
